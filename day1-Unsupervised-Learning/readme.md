...
Let's talk about multivariate similarity. Just like the name sounds, it is a metric that assesses similarity between multivariate data (data with multiple features per sample). That could be patients with 1000s of gene expression data for example.  
